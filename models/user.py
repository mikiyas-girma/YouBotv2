...
from sqlalchemy import Column, Date, Integer, String, BigInteger, Unicode
...
class User(Base):
    ...
    telegram_id = Column(BigInteger, primary_key=True, unique=True,
                         nullable=False)
    name = Column(Unicode(255), nullable=False, default='Anonymous')
    username = Column(String(255), unique=True, index=True)
    gender = Column(String(255), default=None)
    bio = Column(Unicode(255), default='You don''t have a bio yet.')
